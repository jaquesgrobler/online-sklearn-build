...
.. raw:: html
    ...
    <p>This script shows how to sample points from a Hiden Markov Model (HMM): we use a 4-components w...
    </p></div>
    </div>
...
.. raw:: html
    ...
    <p>This examples shows how a classifier is optimized by "nested" cross-validation, which is done u...
    </p></div>
    </div>
...
.. raw:: html
    ...
    <p>This script shows how to use Gaussian HMM. It uses stock price data, which can be obtained from...
    </p></div>
    </div>
...
.. raw:: html
    ...
    <p>In this example with compare the various initialization strategies for K-means in terms of runt...
    </p></div>
    </div>
...
.. raw:: html
    ...
    <p>An example that compares various convex loss functions.
    </p></div>
    </div>
...
.. raw:: html
    ...
    <p>Comparison of different linear SVM classifiers on the iris dataset. It will plot the decision s...
    </p></div>
    </div>
