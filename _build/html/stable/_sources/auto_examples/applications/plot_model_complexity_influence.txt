...
**Script output**::
  ...
  Benchmarking SGDClassifier(alpha=0.001, class_weight=None, epsilon=0.1, eta0=0.0,
         ...
         warm_start=False)
  Complexity: 1 | Hamming Loss (Misclassification Ratio): 0.2562 | Pred. Time: 0.032763s
  ...
  Benchmarking SGDClassifier(alpha=0.001, class_weight=None, epsilon=0.1, eta0=0.0,
         ...
         power_t=0.5, random_state=None, shuffle=False, verbose=0,
         warm_start=False)
  Complexity: 1 | Hamming Loss (Misclassification Ratio): 0.2939 | Pred. Time: 0.024898s
  ...
  Benchmarking SGDClassifier(alpha=0.001, class_weight=None, epsilon=0.1, eta0=0.0,
         ...
         power_t=0.5, random_state=None, shuffle=False, verbose=0,
         warm_start=False)
  Complexity: 1 | Hamming Loss (Misclassification Ratio): 0.3194 | Pred. Time: 0.020280s
  ...
  Benchmarking SGDClassifier(alpha=0.001, class_weight=None, epsilon=0.1, eta0=0.0,
         ...
         power_t=0.5, random_state=None, shuffle=False, verbose=0,
         warm_start=False)
  Complexity: 1 | Hamming Loss (Misclassification Ratio): 0.3347 | Pred. Time: 0.018428s
  ...
  Complexity: 10 | MSE: 27.9672 | Pred. Time: 0.000056s
  
  Benchmarking GradientBoostingRegressor(alpha=0.9, init=None, learning_rate=0.1, loss=ls,
               max_depth=3, max_features=None, min_samples_leaf=1,
               min_samples_split=2, n_estimators=50, random_state=None,
               subsample=1.0, verbose=0)
  Complexity: 50 | MSE: 8.3831 | Pred. Time: 0.000126s
  
  Benchmarking GradientBoostingRegressor(alpha=0.9, init=None, learning_rate=0.1, loss=ls,
               max_depth=3, max_features=None, min_samples_leaf=1,
               min_samples_split=2, n_estimators=100, random_state=None,
               subsample=1.0, verbose=0)
  Complexity: 100 | MSE: 7.0529 | Pred. Time: 0.000214s
  
  Benchmarking GradientBoostingRegressor(alpha=0.9, init=None, learning_rate=0.1, loss=ls,
               max_depth=3, max_features=None, min_samples_leaf=1,
               min_samples_split=2, n_estimators=200, random_state=None,
               subsample=1.0, verbose=0)
  Complexity: 200 | MSE: 5.8951 | Pred. Time: 0.000411s
  
  Benchmarking GradientBoostingRegressor(alpha=0.9, init=None, learning_rate=0.1, loss=ls,
               max_depth=3, max_features=None, min_samples_leaf=1,
               min_samples_split=2, n_estimators=500, random_state=None,
               subsample=1.0, verbose=0)
  Complexity: 500 | MSE: 6.0524 | Pred. Time: 0.000889s
...
**Total running time of the example:**  42.80 seconds 
( 0 minutes  42.80 seconds)
